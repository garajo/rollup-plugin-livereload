...
export default function livereload (options = { watch: '' }) {
  ...
  return {
    name: 'livereload',
    banner () {
      return `(function(l, i, v, e) { v = l.createElement(i); v.async = 1; v.src = '//' + (location.host || 'localhost').split(':')[0] + ':${port}/livereload.js?snipver=1'; e = l.getElementsByTagName(i)[0]; l.head.appendChild(v)})(document, 'script');`
    },
    ongenerate () {
      if (!enabled) {
        enabled = true
